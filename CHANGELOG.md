...
## v0.2.1dev - 16th May 2023

### `Added`
	modules/local/flexbar.nf		  : Addition of flexbar containerisation
	modules/local/generatebarcodes.nf : Addition of Python containerisation
...
### `Added`
	cracflexalign.nf: Addition of channeling to pre-FASTQC input to stop re-running on the same reads for each sample ID 
